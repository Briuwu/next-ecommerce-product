...
I've learned how to build a simple image slider using a library, and built a working lightbox. I also further improve my tailwind skills and learn how to use NextJS for the first time.
